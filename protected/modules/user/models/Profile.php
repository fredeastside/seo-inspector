...
class Profile extends UActiveRecord
{
	...
	public function rules()
	{
		if (!$this->_rules) {
            ...
            array_push($rules,array('filename', 'file','allowEmpty'=>true,'types'=>'png,jpg,gif', 'maxSize' => '100000'));
    ...
    public function behaviors(){
        return array(
            'image' => array(
                ...
                'fallback_image' => '/themes/production/images/userpic.png',// images/users/Profile/default.png',
                'path' => "upload/:model/:id.:ext",
